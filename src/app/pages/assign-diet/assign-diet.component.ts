...
@Component({
  ...
  styleUrl: './assign-diet.component.scss'
})
export class AssignDietComponent {
  dietGroupForm: FormGroup;
  mode: Mode = 'create';
  submitButtonText: string = 'Assign Diet Group';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AssignDietComponent>,
